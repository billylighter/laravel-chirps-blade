    ...
    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
        <form method="POST" action="{{ route('chirps.store') }}">
            ...
            <div class="mb-1">
                <textarea
                    name="description"
                    placeholder="{{ __('Description goes here') }}"@class(['border-red-500' => $errors->has('description'), 'block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm'])>
                    {{ old('description') }}
                </textarea>
